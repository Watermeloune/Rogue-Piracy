...
RoguePiracy: main.o Bateau.o Matelot.o Equipage.o Fonctions.o
	g++ -o $(EXEDIR)/$@ $(OBJDIR)/main.o $(OBJDIR)/Bateau.o $(OBJDIR)/Matelot.o $(OBJDIR)/Fonctions.o $(OBJDIR)/Equipage.o -L./SFML-2.4.2/lib -lsfml-graphics -lsfml-window -lsfml-system
