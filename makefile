...
RoguePiracy: main.o Bateau.o Matelot.o Equipage.o Fonctions.o Arme.o Objet.o Ile.o
	g++ -o $(EXEDIR)/$@ $(OBJDIR)/main.o $(OBJDIR)/Bateau.o $(OBJDIR)/Matelot.o $(OBJDIR)/Objet.o $(OBJDIR)/Arme.o $(OBJDIR)/Fonctions.o $(OBJDIR)/Equipage.o $(OBJDIR)/Ile.o -L./SFML-2.4.2/lib -lsfml-graphics -lsfml-window -lsfml-system
